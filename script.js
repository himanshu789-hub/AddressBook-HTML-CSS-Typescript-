...
var AddressBook = {
    ...
    RemoveEventListener: function () {
        ...
        var mobile = document.getElementById("mobile"); //make it extensionable
    ...
    Insert: function () {
        ...
        var mobile = document.getElementById("mobile").value; //make it extensionable
        ...
        contact.MobileNumbers = new Array();
    ...
    GetContact: function () {
        ...
        AddressBook.ContactToUpdate.prototype.MobileNumbers = new Array();
    ...
    ShowContact: function () {
        ...
        var emailId = document.getElementById("displayEmailId");
        var mobile = document.getElementById("displayMobile");
        var landline = document.getElementById("displayLandline");
        var website = document.getElementById("displayWebsite");
    ...
    DisplaySectionToggleOn: function () {
        var display_bar = document.getElementById("d-bar");
        var add_bar = document.getElementById("add-bar");
        add_bar.parentNode.style.display = "none";
    ...
    MsgCorrectInfo: function (element) {
        switch (element.name) {
            case 'name':
    ...
    EditSection: document.getElementById("update-bar"),
    UpdateSection: document.getElementById("commit-cancel-bar"),
    ...
    FormSectionToggleOn: function () {
        var display_bar = document.getElementById("d-bar");
        var add_bar = document.getElementById("add-bar");
        add_bar.parentNode.style.display = "block";
        AddressBook.ClearForm();
    ...
    ClearForm: function () {
        ...
        document.getElementById("mobile").value = ""; //make it extensionable
    ...
    Initialize: function () {
        ...
        object1.MobileNumbers = new Array();
        ...
        object2.MobileNumbers = new Array();
    ...
    Commit: function () {
        ...
        var num = new MobileNumber();
        num.ContactNumber = mobile.value;
